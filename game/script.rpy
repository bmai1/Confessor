...
label start:
    ...
    "I almost hope it stays that way, because it's comfortable,"
    
    "that feeling of security that comes with constancy.\n"

    "My therapist once advised me to stop overthinking about the past or future and simply do what I want to in the present."

    "She jokingly said that even if I became a serial killer, at least I'd have figured out what I was passionate about."

    nvl clear
    
    "At the time, I thought her advice was something really obvious, something that I didn't need to be told."
